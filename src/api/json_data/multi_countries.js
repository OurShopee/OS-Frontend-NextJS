const countriesData = [
  {
    ...
    //dev_url: "http://192.168.1.47:3000",
    dev_url: "http://localhost:3000",
    name: "UAE",
    currency: "AED",
    backedn_api: process.env.NEXT_PUBLIC_UAE_BACKEND_API,
    gtm_tag: "GTM-MJN7RD8",
    image: "UAE.svg",
    ...
    nav_items: [
      {
        ...
        image: "/assets/vector_icons/Top_left_banner/beat.png",
  ...
  },
  {
    ...
    name: "Oman",
    currency: "OMR",
    backedn_api: process.env.NEXT_PUBLIC_OMAN_BACKEND_API,
    gtm_tag: "GTM-KTJMPS8",
    image: "oman.svg",
    helpline_numbers: {
  ...
  },
  {
    ...
    name: "Qatar",
    currency: "QAR",
    backedn_api: process.env.NEXT_PUBLIC_QATAR_BACKEND_API,
    gtm_tag: "GTM-TRZMJF6",
    image: "qatar.svg",
    helpline_numbers: {
  ...
  },
  {
    ...
    name: "Kuwait",
    currency: "KD",
    backedn_api: process.env.NEXT_PUBLIC_KUWAIT_BACKEND_API,
    gtm_tag: "GTM-PBBLGVM",
    image: "kuwait.svg",
    helpline_numbers: {
  ...
  },
  {
    ...
    name: "Bahrain",
    currency: "BHD",
    backedn_api: process.env.NEXT_PUBLIC_BAHRAIN_BACKEND_API,
    gtm_tag: "GTM-T2H2947",
    image: "bahrain.svg",
    helpline_numbers: {
