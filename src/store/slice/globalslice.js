...
import { Navigationapi, getbannerlistapi } from "@/api/products";
import {
  getLocationsApi,
  getAreasApi,
  getblogs,
...
export const getbannerlistapilist = createAsyncThunk(
...
export const blogByCatIdapi = createAsyncThunk(
  "fetchblogcatdata",
  async (input_data) => {
