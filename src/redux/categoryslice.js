...
export const getCatScreenList = createAsyncThunk("getCatScreenList", async (slug) => {
...
export const { setcatloading,setsubcategoryScreen,setdisplayed_products,sethas_more,setcurrent_page,setsection_pages_Data,setsectionloading,setscrolled_products } = categoryslice.actions
