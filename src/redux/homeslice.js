import {
  bundle_clearance_saleApi,
  getbannerApi,
  getbrand_weekApi,
  getcategory_itemsApi,
  getdeal_offersApi,
  getDealOfTheDayApi,
  getSaverZoneApi,
...
export const getdeal_offersList = createAsyncThunk(
  "getdeal_offersList",
  async () => {
...
export const getDealOfTheDayList = createAsyncThunk(
  "getDealOfTheDayList",
  async () => {
...
export const getSaverZoneList = createAsyncThunk(
  "getSaverZoneList",
  async () => {
...
export const getTopSellingList = createAsyncThunk(
  "getTopSellingList",
  async () => {
...
export const getcategory_items = createAsyncThunk(
  "getcategory_items",
  async () => {
...
export const gettop_selling_product = createAsyncThunk(
...
export const getbundle_clearance_sale = createAsyncThunk(
