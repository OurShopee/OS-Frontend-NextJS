...
export const getProductDetail = createAsyncThunk("getProductDetail", async (slug) => {
    const res = await getproduct_detail(slug);
    return res.data.data.product
});

export const getrelatedItems = createAsyncThunk("getrelatedItems", async (input_data) => {
