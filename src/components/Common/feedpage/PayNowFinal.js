    ...
    <div className="bg-white">
      <div className="flex flex-col lg:flex-row gap-6 p-8">
                        ...
                        <div className="flex-1 flex items-start justify-between gap-4">
                          <div className="flex-1">
                            <div className="paymentmethod-label">
                              <span className="flex items-center justify-start font-medium text-[#191B1C]">
                                {paymentMethod?.image && (
                                  <img
        ...
        <div className="flex-1 w-full">
          <div className="flex flex-col gap-3 md:rounded-3xl md:border border-[#F0F0F0] md:p-6 md:shadow-[0_10px_40px_rgba(0,0,0,0.06)] ">
            <h3 className="text-xl font-semibold text-[#191B1C]">
              Price Details
            </h3>
            ...
            <div className="flex flex-col gap-2 text-[#4F4F4F] text-sm">
              {[
                ...
                <div key={item.label} className="flex items justify-between">
                  ...
                  <span
                    className={`flex items-center text-[16px] font-medium text-[#191B1C]`}
                  >
            ...
            <div className={`space-y-3 ${isMobile && "mb-24"}`}>
              <CheckCoupan
                prodId={product?.id}
                qty={qty}
                sku={sku}
            ...
            {!isMobile && (
              <div className="flex flex-col gap-2">
                <div
                  style={{
                    backgroundImage: `url(${getAssetsUrl(
                      "vector_icons/cart_sidebar_wave.svg"
                    )})`,
                  }}
                ...
                <button
                  ...
                  className={`flex justify-center items-center w-full rounded-2xl bg-[#ffce0b] py-3 text-lg font-semibold text-[#1E1E1E] gap-2 ${
            ...
            <div className="flex items-center justify-center gap-1 text-[#33B056] text-base font-medium pt-2">
              <BsShieldFillCheck />
        ...
        <div className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-[#EAEAEA] px-4 py-3 shadow-[0_-6px_20px_rgba(0,0,0,0.08)] space-y-3">
          <div className="flex flex-col gap-0">
            ...
            <button
              onClick={handleSubmit}
              disabled={isSubmitting}
              className={`flex justify-center items-center w-full rounded-lg bg-[#ffce0b] py-3 text-lg font-semibold text-[#1E1E1E] gap-2 ${
                isSubmitting ? "opacity-70 cursor-not-allowed" : ""
              }`}
            >
              <div>{isSubmitting ? "Processing..." : "Pay Now"}</div>
