...
const PayLaterModal = ({ onPayNow, onPayLater, promoImages = [] }) => {
  const bgImage = getAssetsUrl("webFeed/pay-later-bg.png");
  const qrImage = getAssetsUrl("webFeed/qr.svg");
  const downloadBadges = promoImages?.slice(1, 3) || [];
  ...
  return (
    <div className="relative flex flex-col items-center p-4">
      ...
      {/* Title */}
      <p className="text-2xl font-bold text-black mb-10.5">
        Your Order Is Being Generated!
      </p>

      {/* Content Card */}
      <div className="bg-white rounded-3xl p-6 w-full max-w-lg flex flex-col items-center ">
        ...
        {/* {qr code} */}
        <div className="rounded-[32px] w-[328px] h-[286px] bg-gradient-to-b from-[#A7F37A] via-[#DAF8B7] to-[#FFF7D6] p-6 shadow-lg border border-white/60">
          <p
