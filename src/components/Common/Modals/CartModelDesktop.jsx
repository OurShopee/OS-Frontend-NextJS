                    ...
                    <React.Fragment key={i}>
                      <article className="flex items-center gap-3 py-2">
                        ...
                        <div className="cart-item-info flex-1">
                          <button
                            onClick={() =>
                              navigateToProduct(item.url, item.sku)
                            }
                          ...
                          <div
                            className={`text-lg font-semibold flex flex-col gap-1`}
                          >
                            ...
                            <div
                              className={`text-sm line-through text-[#9EA5A8] ${
                                currentLanguage === "ar"
                                  ? "text-right"
                                  : "text-left"
                              }`}
            ...
            <div className="flex justify-between items-center p-4 bg-white font-semibold">
              ...
              <div className="flex items-center gap-1">
                <p className="mb-0 text-sm line-through text-[#9EA5A8]">
                  <span
                    aria-label={`Original total: ${currentcountry?.currency} ${totalOld}`}
                    className="flex items-center"
                  >
                    {currentcountry?.currency == "AED" ? (
                      <span
