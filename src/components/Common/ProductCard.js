    ...
    >
      ...
      <div className="relative p-4 pb-0 flex items-center justify-center">
        ...
        {isMobile && (
          ...
          >
            <img src={getAssetsUrl("vector_icons/shopping_cart.svg")} alt={"cart"} className="w-5 h-5" loading="lazy" />
          </button>
        )}
        {/* ----------------------------------------------------------------------- */}
      </div>
      ...
      <div className="px-2 py-3 flex flex-col gap-1.5 mt-auto">
        ...
        <div className="relative min-h-[40px]">
          ...
          >
            ...
            >
              {/* <FaCartPlus size={18} /> */}
              <img src={getAssetsUrl("vector_icons/cart.png")} alt={"cart"} className="w-4 h-4" loading="lazy" />
