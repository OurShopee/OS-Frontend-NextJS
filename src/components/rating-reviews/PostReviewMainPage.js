const PostReviewMainPage = ({
  ...
  return (
    <div className="w-full flex flex-col gap-3 md:gap-6 bg-white rounded-2xl border-[#EDEDED] tw_border_rr_first p-3 md:p-8 mb-3">
      <div className="relative">
        ...
        <div className={`flex justify-start sm:space-x-2 py-0 sm:py-2`}>
          {[1, 2, 3, 4, 5].map((star) => (
            <button
              key={star}
              type="button"
...
export default PostReviewMainPage;
